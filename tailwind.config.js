...
module.exports = {
  ...
  theme: {
    extend: {
      ...
      dropShadow:{
        "text-sm":"1px 1px 0px rgba(0,0,0,0.9)",
        "text-md":"1px 2px 0px rgba(0,0,0,0.9)",
        "text-lg":"1px 4px 0px rgba(0,0,0,0.9)",
      },
      container:{
        center:true,
        padding:{
      ...
      fontSize:{
        ...
        xl:["clamp(1.42rem,calc(1.06rem+1.80vw),2.93rem)","1.2"],
